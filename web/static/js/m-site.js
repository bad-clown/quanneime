if(window.jQuery){
    ...
    $(function(){
        ...
        $body.on("click","[data-type=number] .input-group-addon",function(){
            ...
            var pastedText = undefined, $btn=$(this),$num = $btn.find(".number");
            ...
            e.preventDefault();
            pastedText = Math.min($btn.attr("data-max")||Number.MAX_VALUE,parseInt(pastedText.replace(/[^0-9]/g,""),10)||1);
            pastedText && ($num.val(pastedText));
        });
        //cart
