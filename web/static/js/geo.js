...
function change(v) {
    ...
    ;
    var ss = document.getElementById(s[v]),oldV = (ss.options[ss.selectedIndex]||{value:''}).value,oldSelected = false;
    with (ss) {
        length = 0;
        ...
        if (v && document.getElementById(s[v - 1]).selectedIndex > 0 || !v) {
            if (dsy.Exists(str)) {
                    ...
                    if (v && (!oldSelected))options[0].selected = true;
                }
            }
